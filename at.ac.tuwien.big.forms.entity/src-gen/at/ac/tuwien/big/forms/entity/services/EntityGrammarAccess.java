...
public class EntityGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class EntityModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.EntityModel");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cEntityModelElementsAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cEntityModelElementsEntityModelElementParserRuleCall_0_0 = (RuleCall)cEntityModelElementsAssignment_0.eContents().get(0);
		...
		public Assignment getEntityModelElementsAssignment_0() { return cEntityModelElementsAssignment_0; }

		//EntityModelElement
		public RuleCall getEntityModelElementsEntityModelElementParserRuleCall_0_0() { return cEntityModelElementsEntityModelElementParserRuleCall_0_0; }
	...
	public class EntityModelElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.EntityModelElement");
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.Entity");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cFeaturesAssignment_7_0 = (Assignment)cGroup_7.eContents().get(0);
		private final RuleCall cFeaturesFeatureParserRuleCall_7_0_0 = (RuleCall)cFeaturesAssignment_7_0.eContents().get(0);
		private final Group cGroup_7_1 = (Group)cGroup_7.eContents().get(1);
		private final Keyword cCommaKeyword_7_1_0 = (Keyword)cGroup_7_1.eContents().get(0);
		private final Assignment cFeaturesAssignment_7_1_1 = (Assignment)cGroup_7_1.eContents().get(1);
		...
		//	'{'
		//	'id' id=[Attribute|QualifiedName] ',' (features+=Feature (',' features+=Feature)*)?
		//	'}';
		@Override public ParserRule getRule() { return rule; }

		//'entity' name=ID ('extends' superType=[Entity|QualifiedName])? '{' 'id' id=[Attribute|QualifiedName] ','
		...
		//Feature
		public RuleCall getFeaturesFeatureParserRuleCall_7_0_0() { return cFeaturesFeatureParserRuleCall_7_0_0; }
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.Feature");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class RelationshipElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.Relationship");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EnumerationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.Enumeration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.Literal");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "at.ac.tuwien.big.forms.entity.Entity.AttributeType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
